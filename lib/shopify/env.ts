...
export const SHOPIFY_CUSTOMER_SCOPES =
  process.env.EXPO_PUBLIC_SHOPIFY_CUSTOMER_SCOPES || "openid email profile customer.read customer.write"
export const SHOPIFY_CUSTOMER_REDIRECT_PATH =
  process.env.EXPO_PUBLIC_SHOPIFY_CUSTOMER_REDIRECT_PATH || "auth/shopify"
